...
'''
parameters_bias = [p[1] for p in net.named_parameters() if 'biases' in p[0]]
parameters_scale = [p[1] for p in net.named_parameters() if 'scale' in p[0]]
parameters_others = [p[1] for p in net.named_parameters() if not ('biases' in p[0] or 'scale' in p[0])]
optimizer = optim.SGD(
